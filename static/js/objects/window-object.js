...
export class WindowObject extends BaseGameObject {
  ...
  render(context) {
    ...
    context.fillText("MESSAGE", this.titleBarTextX, this.titleBarTextY);
    // Message Title
    context.fillStyle = "#FFFFFF";
    context.font = "20px system-ui";
    context.textAlign = "left";
    context.fillText(
      this.title,
      this.messageTitleTextX,
      this.messageTitleTextY
    );
    // Message Content
    context.fillStyle = "#FFFFFF";
  ...
  calculatePositions() {
    ...
    this.messageTitleTextX = this.x + 14;
    this.messageTitleTextY = this.y + 68;
